...
public class RegisterTest {
	WebDriver chrome;
	  ...
	  public void register() {
		  ...
		  email.sendKeys("kannan230999@gmail.com");
...
//		  lname.sendKeys("kumar");
	  ...
	  public void login()
	  {
	  	...
	  	
	  	{
	  		 ...
	  		 chrome.get("http://automationpractice.com/index.php?id_product=2&controller=product");
